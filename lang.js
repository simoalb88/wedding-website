...
const I18N = {
    en: {
        ...
        'faq.events.title': 'Other Events?',
        'faq.events.p': "At this time, we don't have any formal events planned beyond the wedding day. We'll be in town during the week of the wedding and would love to meet up if timing allows. We also encourage guests to explore, relax, and enjoy Italy and beyond at their own pace.",
        'faq.transport.title': 'Transportation',
        'faq.transport.p': "We'll be providing transportation on the wedding day from Stresa to our venue and back at the end of the night. More details coming soon!",
        ...
        // Travel — Train
        'travel.train.p1': 'Stresa is well connected by rail on the <span class="highlight">Milano–Domodossola line</span>. From Milan Centrale, direct regional trains run to Stresa throughout the day—no reservation required.',
        'travel.train.p2': "If you're traveling from elsewhere in Italy or Europe, Milan Centrale is a major hub with connections from most major cities.",
        'travel.train.from.label': 'From Milan',
        'travel.train.from.val': '~1 hour 15 minutes',
        'travel.train.cost.label': 'Cost',
        'travel.train.cost.val': '~€10–15',
        'travel.train.note': 'Regional trains don\'t require seat reservations. Check schedules at <a href="https://www.trenitalia.com" target="_blank">trenitalia.com</a>.',
        // Travel — Car
    ...
    it: {
        ...
        'faq.events.title': 'Altri eventi?',
        'faq.events.p': "Al momento non abbiamo eventi ufficiali in programma oltre al giorno del matrimonio. Saremo in zona durante la settimana delle nozze e ci farebbe piacere vederci, se i tempi lo permettono. Invitiamo inoltre gli ospiti a esplorare, rilassarsi e godersi l'Italia e dintorni con i propri ritmi.",
        'faq.transport.title': 'Trasporti',
        'faq.transport.p': "Il giorno del matrimonio metteremo a disposizione il trasporto da Stresa alla location e ritorno a fine serata. Maggiori dettagli a breve!",
        ...
        // Travel — Train
        'travel.train.p1': 'Stresa è ben collegata via treno sulla <span class="highlight">linea Milano–Domodossola</span>. Da Milano Centrale, treni regionali diretti raggiungono Stresa durante tutta la giornata—senza prenotazione.',
        'travel.train.p2': "Se arrivate da altre zone d'Italia o d'Europa, Milano Centrale è un grande snodo con collegamenti dalla maggior parte delle città principali.",
        'travel.train.from.label': 'Da Milano',
        'travel.train.from.val': '~1 ora e 15 minuti',
        'travel.train.cost.label': 'Costo',
        'travel.train.cost.val': '~€10–15',
        'travel.train.note': 'I treni regionali non richiedono prenotazione del posto. Controllate gli orari su <a href="https://www.trenitalia.com" target="_blank">trenitalia.com</a>.',
        // Travel — Car
